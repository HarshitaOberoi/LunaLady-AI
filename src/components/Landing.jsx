      ...
      >
        ...
        <div className="max-w-6xl mx-auto space-y-12">
            ...
            <div className="flex flex-col md:flex-row items-center gap-8">
              <div className="w-full md:w-1/2 pr-8">
                <h2 className="text-4xl font-bold mb-4 text-gray-900 dark:text-gray-100">
                  LunaLady AI: Your Journey to Confident Cycles
                </h2>
          ...
          <Card className=" hover:bg-pink-200  focus:outline-none focus:ring focus:ring-pink-300 dark:hover:bg-pink-500 ">
            <h3 className="text-2xl font-semibold mb-6 text-gray-900 dark:text-gray-100  ">
              Key Benefits of Using LunaLady AI
            </h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <BenefitItem
                title="Personalized Insights"
                description="LunaLady AI offers a shared platform with dual dashboards, ensuring parents stay informed without invading their child's privacy, fostering trust and security."
              />
              <BenefitItem
                title="Holistic Approach"
                description="Unlike traditional platforms, LunaLady AI addresses the unique needs of young menstruators with personalized tools for tracking cycles and early detection of menstrual issues."
              />
              <BenefitItem
              ...
              <BenefitItem
                ...
                description="LunaLady AI encourages open dialogue between parents and children about menstruation, helping build a supportive, trusting relationship and enhancing emotional well-being."
              />
            </div>
          </Card>
          {/* Our Mission Section */}
          <Card className=" hover:bg-pink-200 active:bg-pink-700 focus:outline-none focus:ring focus:ring-pink-300  dark:hover:bg-pink-500">
            ...
            <p className="text-lg mb-4 text-gray-800 dark:text-gray-300">
              LunaLady AI’s mission is to promote period positivity, reduce stigma,
        ...
        {/* <Card className=" hover:bg-pink-200 active:bg-pink-700 focus:outline-none focus:ring focus:ring-pink-300  dark:hover:bg-pink-500">
          ...
          <Card className=" hover:bg-pink-200 active:bg-pink-700 focus:outline-none focus:ring focus:ring-pink-300  dark:hover:bg-pink-500">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <TestimonialCard
                quote="LunaLady AI has completely changed how I manage my health. It's like having a personal health assistant!"
                author="Divya Jain"
              />
              <TestimonialCard
         ...
         {/* <Card className=" hover:bg-pink-200 active:bg-pink-700 focus:outline-none focus:ring focus:ring-pink-300  dark:hover:bg-pink-500">
          ...
          <Card className="bg-pink-800 text-white  hover:bg-pink-200 active:bg-pink-100 focus:outline-none focus:ring focus:ring-pink-300  dark:hover:bg-pink-500">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <SuccessStoryCard
                ...
                name="Anubha Garg"
                story="After struggling with irregular cycles for years, LunaLady AI helped me understand my body better. Within 3 months, I could predict my cycle accurately!"
                improvement="Cycle Regularity"
              />
              <SuccessStoryCard
                name="Riya Sharma"
                story="The nutritional guidance on LunaLady AI transformed my diet. My energy levels have improved, and I've noticed a significant reduction in PMS symptoms."
              ...
              <SuccessStoryCard
                ...
                story="This app has helped me maintain a well balanced and nutritious diet. I have been able to feel strong even during my periods thanks to LunaLady AI."
          ...
          <Card className=" hover:bg-pink-200 active:bg-pink-100 focus:outline-none focus:ring focus:ring-pink-300  dark:hover:bg-pink-500">
            ...
            <div className="space-y-6">
              <ExpertInsightCard
                ...
                insight="Regular tracking of menstrual cycles can lead to early detection of various health issues. LunaLady AI's comprehensive tracking features make this process easy and insightful for users."
              />
              <ExpertInsightCard
                expert="Vaishali Shah, Nutritionist"
                insight="The personalized nutritional recommendations provided by LunaLady AIare based on solid scientific research. They can significantly improve hormonal balance and overall health."
              />
            </div>
          </Card>
          ...
          <Card className=" hover:bg-pink-200  focus:outline-none focus:ring focus:ring-pink-300  dark:hover:bg-pink-500">
            ...
            <div className="space-y-4">
              ...
              />
              <FAQItem
                question="Can I use LunaLady AI if I have irregular cycles?"
                answer="LunaLady AI is designed to accommodate all types of cycles, including irregular ones. Our AI adapts to your unique patterns over time."
              />
              <FAQItem
              ...
              />
              <FAQItem
                question="How does LunaLady AI protect my privacy?"
              ...
              />
              <FAQItem
                question="Can I use LunaLady AI if I'm not menstruating?"
                answer="LunaLady AI offers features for all aspects of women's health, including general wellness tracking, nutritional guidance, and mental health support."
              />
              <FAQItem
                question="Are the health articles on LunaLady AI written by professionals?"
          ...
          <Card className=" dark:hover:bg-pink-500  hover:bg-pink-200 active:bg-pink-100 focus:outline-none focus:ring focus:ring-pink-300 ">
            <div className="text-center">
              ...
              <p className="mb-6 text-gray-800 dark:text-gray-300">
                Join LunaLady AI today and start your journey to better health and
                wellness.
              </p>
              <button
                onClick={() => navigate("/Signup")}
          ...
          <footer className="mt-12 pt-8 border-t border-gray-200 dark:border-gray-700  hover:bg-pink-200 active:bg-pink-100 focus:outline-none focus:ring focus:ring-pink-300 dark:hover:bg-pink-400">
            ...
            <div className="mt-8 pt-8 border-t border-gray-200 dark:border-gray-700 text-center">
              ...
              <p className="text-gray-700 dark:text-gray-100">
                &copy; 2025 LunaLady AI. All rights reserved.
              </p>
            </div>
          </footer>
        </div>
